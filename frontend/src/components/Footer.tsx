...
const Footer: FunctionComponent = () => (
	<footer className="footer">
		<div className="buttons">
			...
			<a href="#/" aria-label="Twitter" className="button is-medium">
				<FontAwesomeIcon icon={["fab", "twitter"]} />
			</a>
			<a href="#/" aria-label="Medium" className="button is-medium">
				<FontAwesomeIcon icon={["fab", "etsy"]} />
			</a>
		</div>
		<div className="content has-text-centered">{COPYRIGHT_TEXT}</div>
	</footer>
);
